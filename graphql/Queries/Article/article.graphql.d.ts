 ...
 * });
 */
export declare function useArticleQuery(
...
>
export declare function useArticleLazyQuery(
...
export declare type ArticleLazyQueryHookResult = ReturnType<
  typeof useArticleLazyQuery
>
export declare type ArticleQueryResult = Apollo.QueryResult<
  ArticleQuery,
