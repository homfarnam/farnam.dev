/* b5f1e01a297b8b98804dbb8434e994a6cc6e8c34
...
export declare type ArticlesQueryVariables = Exact<{
    [key: string]: never;
}>;
export declare type ArticlesQuery = ({
    __typename?: 'Query';
} & {
    articles?: Maybe<Array<Maybe<({
        __typename?: 'Articles';
    } & Pick<Articles, 'id' | 'title' | 'description'> & {
        category?: Maybe<({
            __typename?: 'Category';
        } & Pick<Category, 'id' | 'name'>)>;
    })>>>;
});
export declare const ArticlesDocument: Apollo.DocumentNode;
/**
 ...
 * });
 */
export declare function useArticlesQuery(baseOptions?: Apollo.QueryHookOptions<ArticlesQuery, ArticlesQueryVariables>): Apollo.QueryResult<ArticlesQuery, Exact<{
    [key: string]: never;
}>>;
export declare function useArticlesLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<ArticlesQuery, ArticlesQueryVariables>): Apollo.QueryTuple<ArticlesQuery, Exact<{
    [key: string]: never;
}>>;
export declare type ArticlesQueryHookResult = ReturnType<typeof useArticlesQuery>;
export declare type ArticlesLazyQueryHookResult = ReturnType<typeof useArticlesLazyQuery>;
export declare type ArticlesQueryResult = Apollo.QueryResult<ArticlesQuery, ArticlesQueryVariables>;
