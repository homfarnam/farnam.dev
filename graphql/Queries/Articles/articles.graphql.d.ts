...
export declare type Morph =
  ...
  | ArticlesConnectionDescription
  | ArticlesConnectionPublished_At
  | ArticlesConnectionCategory
  | ArticlesConnectionCreated_By
  | ArticlesConnectionUpdated_By
  ...
  | CategoryConnectionCreated_By
  | CategoryConnectionUpdated_By
 ...
 * });
 */
export declare function useArticlesQuery(
...
>
export declare function useArticlesLazyQuery(
...
>
export declare type ArticlesQueryHookResult = ReturnType<
  typeof useArticlesQuery
>
export declare type ArticlesLazyQueryHookResult = ReturnType<
  typeof useArticlesLazyQuery
>
export declare type ArticlesQueryResult = Apollo.QueryResult<
  ArticlesQuery,
  ArticlesQueryVariables
>
